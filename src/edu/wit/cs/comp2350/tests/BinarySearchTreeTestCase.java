...
public class BinarySearchTreeTestCase{
    ...
    public void testInsertSmalBST() {
        ...
        _testInsert(new BST(), new DiskLocation[] {new DiskLocation(1, 1), new DiskLocation(1, 2), new DiskLocation(1, 3)});
        _testInsert(new BST(), new DiskLocation[] {new DiskLocation(1, 3), new DiskLocation(1, 1), new DiskLocation(1, 2)});
    }
